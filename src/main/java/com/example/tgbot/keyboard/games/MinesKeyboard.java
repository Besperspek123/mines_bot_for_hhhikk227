...
public class MinesKeyboard {
    ...
    public static InlineKeyboardMarkup mainForInstructionIfUserIsNotRegistered(String oneWinUrl, String language) {
        ...
        registrationButton.setCallbackData("mines_registration");
        ...
        getVideoInstructionButton.setCallbackData("mines_video_instruction");
//    videoRow.add(getVideoInstructionButton);
        ...
        alreadyRegisteredButton.setCallbackData("mines_give_signal");
        ...
        goToMainButton.setCallbackData("mines");
...
//        videoRow.add(getVideoInstructionButton);
    ...
    public static InlineKeyboardMarkup mainForVideoInstruction(String oneWinUrl,String language){
        ...
        instructionButton.setCallbackData("mines_instruction");
...
//        secondRow.add(getVideoInstructionButton);
    ...
    public static InlineKeyboardMarkup menuWithCancelButtonAndLinkToOneWin(String url, String language) {
        ...
        cancelButton.setCallbackData("mines");
        ...
        checkIdButton.setCallbackData("mines_try_to_registration");
    ...
    public static InlineKeyboardMarkup menuWithCancelLinkForCheckID(String language,UrlService urlService) {
        ...
        cancelButton.setCallbackData("cancel_registration_in_mines");
        secondRow.add(cancelButton);
        keyboard.add(secondRow);
    ...
    public static InlineKeyboardMarkup menuWithCheckTheDeposit(String language) {
        ...
        cancelButton.setCallbackData("mines_give_signal");
        ...
        cancelDepositButton.setCallbackData("mines");
    ...
    public static InlineKeyboardMarkup sendWebAppButton(User user, String language, String oneWinUrl, UrlService urlService) {
        ...
        switch (language) {
            case "russian":
                webAppButton.setText("\uD83C\uDF10 Открыть игру \uD83C\uDF10");
                break;
            case "english":
                webAppButton.setText("\uD83C\uDF10 Open the game \uD83C\uDF10");
                break;
            case "hindi":
                webAppButton.setText("\uD83C\uDF10 खेल खोलें \uD83C\uDF10");
                break;
            case "brazilian":
                webAppButton.setText("\uD83C\uDF10 Abrir o jogo \uD83C\uDF10");
                break;
            case "spanish":
                webAppButton.setText("\uD83C\uDF10 Abrir el juego \uD83C\uDF10");
                break;
            case "uzbek":
                webAppButton.setText("\uD83C\uDF10 O'yinni ochish \uD83C\uDF10");
                break;
            case "azerbaijani":
                webAppButton.setText("\uD83C\uDF10 Oyunu aç \uD83C\uDF10");
                break;
            case "turkish":
                webAppButton.setText("\uD83C\uDF10 Oyunu aç \uD83C\uDF10");
                break;
            case "portuguese":
                ...
                break;
            case "arabic":
                webAppButton.setText("\uD83C\uDF10 افتح اللعبة \uD83C\uDF10");
                break;
            default:
                webAppButton.setText("\uD83C\uDF10 Open the game \uD83C\uDF10");
                break;
        ...
        webAppInfo.setUrl(urlService.getIp() + "/mines?oneWinUrl=" + urlService.getOneWinUrlWithMines(user)); // URL вашего веб-приложения с параметром
