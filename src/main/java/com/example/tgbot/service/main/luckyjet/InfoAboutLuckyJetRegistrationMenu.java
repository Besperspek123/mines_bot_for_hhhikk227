...
@Slf4j
public class InfoAboutLuckyJetRegistrationMenu implements CommandWithCallback {
    ...
    public InfoAboutLuckyJetRegistrationMenu(BotActions botActions, UrlService urlService, UserService userService, PromoService promoService) {
    ...
    public void execute(long chatId, CallbackQuery callbackQuery) {
        ...
        if(currentUser.getIsVerify()){
            ...
            if (userService.userIsRussian(currentUser)){
                botActions.sendPhoto(chatId,"/imagesrussian/luckyjet/registration.jpg");
            }
            else {
                botActions.sendPhoto(chatId,"/imagesenglish/luckyjet/registration.jpg");
            }
            String answer = "";
            ...
            InlineKeyboardMarkup inlineKeyboardMarkup = LuckyJetKeyboard.menuWithCancelButtonAndLinkToOneWin(urlService.getOneWinUrl(currentUser),currentUser.getLanguage());
