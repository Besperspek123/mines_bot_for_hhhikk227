...
@Slf4j
public class InfoAboutCoinRegistrationMenu implements CommandWithCallback {
    ...
    public InfoAboutCoinRegistrationMenu(BotActions botActions, UrlService urlService, UserService userService, PromoService promoService) {
    ...
    public void execute(long chatId, CallbackQuery callbackQuery) {
        ...
        if(currentUser.getIsVerify()){
            ...
            if (userService.userIsRussian(currentUser)){
                botActions.sendPhoto(chatId,"/imagesrussian/coinflip/registration.jpg");
            }
            else {
                botActions.sendPhoto(chatId,"/imagesenglish/coinflip/registration.jpg");
            }
            String answer = "";
            ...
            InlineKeyboardMarkup inlineKeyboardMarkup = CoinFlipKeyboard.menuWithCancelButtonAndLinkToOneWin(urlService.getOneWinUrl(currentUser),currentUser.getLanguage());
