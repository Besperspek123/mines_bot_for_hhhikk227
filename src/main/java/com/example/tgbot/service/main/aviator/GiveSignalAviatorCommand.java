...
@Slf4j
public class GiveSignalAviatorCommand implements CommandWithCallback {
    ...
    public GiveSignalAviatorCommand(BotActions botActions, UrlService urlService, UserService userService, PromoService promoService, DepositService depositService) {
    ...
    public void execute(long chatId, CallbackQuery callbackQuery) {
        ...
        if(!currentUser.getIsVerify()){
            CommandWithCallback infoAboutRegistrationMenu = new InfoAboutAviatorRegistrationMenu(botActions,urlService,userService,promoService);
            ...
            if (currentUser.getOneWinId() != null){
                if(depositService.isPlayerDeposited(Long.toString(currentUser.getOneWinId()))){
                    ...
                    CommandWithCallback infoAboutDepositMenu = new InfoAboutAviatorDepositMenu(botActions,urlService,userService,promoService);
    ...
    public void showWebApp(long chatId) {
        ...
        InlineKeyboardMarkup inlineKeyboardMarkup = AviatorKeyboard.sendWebAppButton(user,user.getLanguage(),urlService.getOneWinUrlWithAviator(user),urlService);
        String answer = "";
        switch (user.getLanguage()) {
            ...
            case "english":
                ...
                break;
            case "hindi":
                answer = "🚀 संकेत प्राप्त करने के लिए, नीचे दिए गए बटन का उपयोग करके एप्लिकेशन खोलें! ✔️";
                break;
            case "brazilian":
            ...
            case "spanish":
                ...
                break;
            case "uzbek":
                answer = "🚀 Signal olish uchun, quyidagi tugmani bosib dasturini oching! ✔️";
                break;
            case "azerbaijani":
