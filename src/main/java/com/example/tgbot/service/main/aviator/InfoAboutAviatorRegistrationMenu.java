...
@Slf4j
public class InfoAboutAviatorRegistrationMenu implements CommandWithCallback {
    ...
    public InfoAboutAviatorRegistrationMenu(BotActions botActions, UrlService urlService, UserService userService, PromoService promoService) {
    ...
    public void execute(long chatId, CallbackQuery callbackQuery) {
        ...
        if(currentUser.getIsVerify()){
            ...
            if (userService.userIsRussian(currentUser)){
                botActions.sendPhoto(chatId,"/imagesrussian/aviator/registration.jpg");
            }
            else {
                botActions.sendPhoto(chatId,"/imagesenglish/aviator/registration.jpg");
            }
            String answer = "";
            ...
            InlineKeyboardMarkup inlineKeyboardMarkup = AviatorKeyboard.menuWithCancelButtonAndLinkToOneWin(urlService.getOneWinUrl(currentUser),currentUser.getLanguage());
